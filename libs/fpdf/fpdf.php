...
function Header()
{
	...
	//$this->Image(BASE_URL.'public/img/logo_bio.png',3,4,22,12,"PNG");
}
...
function Footer()
{
	...
	//$this->Ln(5);
	/*$this->SetY(64);
	$this->Cell(100,5,'________________________________________________________________________',0,1,'L');
	$this->SetFont('Arial','B',16);
	$this->Cell(100,5,$_SESSION['fullname'],0,1,'L');*/
